...
setup(
    ...
    version="0.4.1.1",  # Start with a small number and increase it with every change you make
    ...
    download_url="https://github.com/ubcaerodesign/ubcaerodesign/archive/refs/tags/pypi-0.4.1.1.tar.gz",  # I explain this later on
    keywords=["aerodesign"],  # Keywords that define your package best
    install_requires=["zmq"],  # I get to this in a second
    classifiers=[
